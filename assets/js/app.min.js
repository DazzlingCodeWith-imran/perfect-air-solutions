...
var Swiper = function() {
            ...
            for (let n = 1; n < arguments.length; n += 1) {
                ...
                if (null != s && (i = s, !("undefined" != typeof window && void 0 !== window.HTMLElement ? i instanceof HTMLElement : i && (1 === i.nodeType || 11 === i.nodeType)))) {
                    ...
                    for (let t = 0, n = i.length; t < n; t += 1) {
                        ...
                        void 0 !== r && r.enumerable && (c(e[n]) && c(s[n]) ? s[n].__swiper__ ? e[n] = s[n] : u(e[n], s[n]) : !c(e[n]) && c(s[n]) ? (e[n] = {}, s[n].__swiper__ ? e[n] = s[n] : u(e[n], s[n])) : e[n] = s[n])
                    }
                }
            }
            var i;
            ...
            D = e => {
                ...
                if (e.params.rewind || e.params.loop)
                    for (let n = s - t; n <= r + t; n += 1) {
                        ...
                        for (let n = Math.max(s - t, 0); n <= Math.min(r + t, i - 1); n += 1) n !== s && (n > r || n < s) && z(e, n)
            };
        ...
        function H(e) {
            ...
            Object.assign(o, {
                ...
                isScrolling: void 0,
                startMoving: void 0
            }), d.startX = g, d.startY = v, o.touchStartTime = l(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, a.threshold > 0 && (o.allowThresholdMove = !1);
            let y = !0;
            u.matches(o.focusableElements) && (y = !1, "SELECT" === u.nodeName && (o.isTouched = !1)), i.activeElement && i.activeElement.matches(o.focusableElements) && i.activeElement !== u && i.activeElement.blur();
        ...
        function W(e) {
            ...
            if (t.activeElement && u.target === t.activeElement && u.target.matches(s.focusableElements)) return s.isMoved = !0, void(i.allowClick = !1);
            s.allowTouchCallbacks && i.emit("touchMove", u), o.previousX = o.currentX, o.previousY = o.currentY, o.currentX = p, o.currentY = h;
            const f = o.currentX - o.startX,
                m = o.currentY - o.startY;
            if (i.params.threshold && Math.sqrt(f ** 2 + m ** 2) < i.params.threshold) return;
            if (void 0 === s.isScrolling) {
                let e;
                i.isHorizontal() && o.currentY === o.startY || i.isVertical() && o.currentX === o.startX ? s.isScrolling = !1 : f * f + m * m >= 25 && (e = 180 * Math.atan2(Math.abs(m), Math.abs(f)) / Math.PI, s.isScrolling = i.isHorizontal() ? e > r.touchAngle : 90 - e > r.touchAngle)
            }
            ...
            if ((new Date).getTime(), s.isMoved && s.allowThresholdMove && y !== i.touchesDirection && b && w && Math.abs(g) >= 1) return Object.assign(o, {
                startX: p,
                startY: h,
                currentX: p,
                currentY: h,
            ...
            if (r.touchReleaseOnEdges && (E = 0), g > 0 ? (b && w && s.allowThresholdMove && s.currentTranslate > (r.centeredSlides ? i.minTranslate() - i.slidesSizesGrid[i.activeIndex + 1] : i.minTranslate()) && i.loopFix({
                    ...
                    setTranslate: !0,
                    activeSlideIndex: 0
                }), s.currentTranslate > i.minTranslate() && (_ = !1, r.resistance && (s.currentTranslate = i.minTranslate() - 1 + (-i.minTranslate() + s.startTranslate + g) ** E))) : g < 0 && (b && w && s.allowThresholdMove && s.currentTranslate < (r.centeredSlides ? i.maxTranslate() + i.slidesSizesGrid[i.slidesSizesGrid.length - 1] : i.maxTranslate()) && i.loopFix({
                    direction: "next",
                    setTranslate: !0,
                    activeSlideIndex: i.slides.length - ("auto" === r.slidesPerView ? i.slidesPerViewDynamic() : Math.ceil(parseFloat(r.slidesPerView, 10)))
                }), s.currentTranslate < i.maxTranslate() && (_ = !1, r.resistance && (s.currentTranslate = i.maxTranslate() + 1 - (i.maxTranslate() - s.startTranslate - g) ** E))), _ && (u.preventedByNestedSwiper = !0), !i.allowSlideNext && "next" === i.swipeDirection && s.currentTranslate < s.startTranslate && (s.currentTranslate = s.startTranslate), !i.allowSlidePrev && "prev" === i.swipeDirection && s.currentTranslate > s.startTranslate && (s.currentTranslate = s.startTranslate), i.allowSlidePrev || i.allowSlideNext || (s.currentTranslate = s.startTranslate), r.threshold > 0) {
        ...
        function B(e) {
            ...
            if (t.allowClick) {
                ...
                t.updateClickedSlide(e && e[0] || s.target, e), t.emit("tap click", s), h < 300 && p - i.lastClickTime < 300 && t.emit("doubleTap doubleClick", s)
            }
            ...
            let f;
            if (i.isTouched = !1, i.isMoved = !1, i.startMoving = !1, f = r.followFinger ? d ? t.translate : -t.translate : -i.currentTranslate, r.cssMode) return;
            ...
            for (let e = 0; e < c.length; e += e < r.slidesPerGroupSkip ? 1 : r.slidesPerGroup) {
                ...
                void 0 !== c[e + t] ? (m || f >= c[e] && f < c[e + t]) && (g = e, v = c[e + t] - c[e]) : (m || f >= c[e]) && (g = e, v = c[c.length - 1] - c[c.length - 2])
            }
            let y = null,
                b = null;
            ...
            if (h > r.longSwipesMs) {
                ...
                "next" === t.swipeDirection && (w >= r.longSwipesRatio ? t.slideTo(r.rewind && t.isEnd ? y : g + _) : t.slideTo(g)), "prev" === t.swipeDirection && (w > 1 - r.longSwipesRatio ? t.slideTo(g + _) : null !== b && w < 0 && Math.abs(w) > r.longSwipesRatio ? t.slideTo(b) : t.slideTo(g))
            } else {
                if (!r.shortSwipes) return void t.slideTo(t.activeIndex);
                !t.navigation || s.target !== t.navigation.nextEl && s.target !== t.navigation.prevEl ? ("next" === t.swipeDirection && t.slideTo(null !== y ? y : g + _), "prev" === t.swipeDirection && t.slideTo(null !== b ? b : g)) : s.target === t.navigation.nextEl ? t.slideTo(g + _) : t.slideTo(g)
            }
        }
        ...
        const $ = (e, t) => {
                ...
                r && "string" != typeof r && (i[d]("touchstart", e.onDocumentTouchStart, {
                    ...
                    passive: !0
                }), (s.preventClicks || s.preventClicksPropagation) && r[d]("click", e.onClick, !0), s.cssMode && o[d]("scroll", e.onScroll), s.updateOnWindowResize ? e[c](a.ios || a.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", R, !0) : e[c]("observerUpdate", R, !0), r[d]("load", e.onLoad, {
                    capture: !0
                }))
            },
        ...
        const Q = {
                ...
                update: {
                    ...
                    updateSlides: function() {
                        ...
                        for (let n = 0; n < u; n += 1) {
                            let s;
                            if (L = 0, c[n] && (s = c[n]), M && e.grid.updateSlide(n, s, c), !c[n] || "none" !== b(s, "display")) {
                                if ("auto" === i.slidesPerView) {
                                    I && (c[n].style[e.getDirectionLabel("width")] = "");
                                ...
                                } else L = (r - (i.slidesPerView - 1) * E) / i.slidesPerView, i.roundLengths && (L = Math.floor(L)), c[n] && (c[n].style[e.getDirectionLabel("width")] = L + "px");
                                c[n] && (c[n].swiperSlideSize = L), g.push(L), i.centeredSlides ? (S = S + L / 2 + T / 2 + E, 0 === T && 0 !== n && (S = S - r / 2 - E), 0 === n && (S = S - r / 2 - E), Math.abs(S) < .001 && (S = 0), i.roundLengths && (S = Math.floor(S)), C % i.slidesPerGroup == 0 && h.push(S), f.push(S)) : (i.roundLengths && (S = Math.floor(S)), (C - Math.min(e.params.slidesPerGroupSkip, C)) % e.params.slidesPerGroup == 0 && h.push(S), f.push(S), S = S + L + E), e.virtualSize += L + E, T = L, C += 1
                            }
                        }
                        if (e.virtualSize = Math.max(e.virtualSize, r) + y, o && a && ("slide" === i.effect || "coverflow" === i.effect) && (n.style.width = e.virtualSize + E + "px"), i.setWrapperSize && (n.style[e.getDirectionLabel("width")] = e.virtualSize + E + "px"), M && e.grid.updateWrapperSize(L, h), !i.centeredSlides) {
                            const t = [];
                        ...
                        if (l && i.loop) {
                            ...
                            for (let n = 0; n < e.virtual.slidesBefore + e.virtual.slidesAfter; n += 1) 1 === i.slidesPerGroup && h.push(h[h.length - 1] + t), f.push(f[f.length - 1] + t), e.virtualSize += t
                        }
                        ...
                        if (u !== d && e.emit("slidesLengthChange"), h.length !== w && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), f.length !== _ && e.emit("slidesGridLengthChange"), i.watchSlidesProgress && e.updateSlidesOffset(), e.emit("slidesUpdated"), !(l || i.cssMode || "slide" !== i.effect && "fade" !== i.effect)) {
                    ...
                    updateSlidesProgress: function(e) {
                        ...
                        for (let e = 0; e < n.length; e += 1) {
                            ...
                            m && (t.visibleSlides.push(l), t.visibleSlidesIndexes.push(e)), O(l, m, i.slideVisibleClass), O(l, f, i.slideFullyVisibleClass), l.progress = s ? -c : c, l.originalProgress = s ? -u : u
                        }
                    },
                    ...
                    updateSlidesClasses: function() {
                        ...
                        else o ? (l = t.filter(e => e.column === s)[0], c = t.filter(e => e.column === s + 1)[0], d = t.filter(e => e.column === s - 1)[0]) : l = t[s];
                        l && (o || (c = function(e, t) {
                            const i = [];
                            ...
                            A(e, e === l, i.slideActiveClass), A(e, e === c, i.slideNextClass), A(e, e === d, i.slidePrevClass)
                        }), e.emitSlidesClasses()
                    },
                    updateActiveIndex: function(e) {
                        ...
                        if (l >= n.length && (l = n.length - 1), d === r && !t.params.loop) return void(l !== a && (t.snapIndex = l, t.emit("snapIndexChange")));
                        ...
                        Object.assign(t, {
                            ...
                            previousIndex: r,
                            activeIndex: d
                        }), t.initialized && D(t), t.emit("activeIndexChange"), t.emit("snapIndexChange"), (t.initialized || t.params.runCallbacksOnInit) && (o !== p && t.emit("realIndexChange"), t.emit("slideChange"))
                    },
                ...
                transition: {
                    ...
                    transitionStart: function(e, t) {
                        ...
                        n.cssMode || (n.autoHeight && i.updateAutoHeight(), j({
                            swiper: i,
                            runCallbacks: e,
                            direction: t,
                            step: "Start"
                    ...
                    transitionEnd: function(e, t) {
                        ...
                        i.animating = !1, n.cssMode || (i.setTransition(0), j({
                            swiper: i,
                            runCallbacks: e,
                            direction: t,
                            step: "End"
                ...
                slide: {
                    slideTo: function(e, t, i, n, s) {
                        ...
                        let b;
                        if (o !== (c || 0) && i && r.emit("beforeSlideChangeStart"), r.updateProgress(y), b = o > u ? "next" : o < u ? "prev" : "reset", p && -y === r.translate || !p && y === r.translate) return r.updateActiveIndex(o), a.autoHeight && r.updateAutoHeight(), r.updateSlidesClasses(), "slide" !== a.effect && r.setTranslate(y), "reset" !== b && (r.transitionStart(i, b), r.transitionEnd(i, b)), !1;
                        if (a.cssMode) {
                            const e = r.isHorizontal(),
                                i = p ? y : -y;
                            if (0 === t) {
                        ...
                        if (s.params.loop)
                            if (s.virtual && s.params.virtual.enabled) o += s.virtual.slidesBefore;
                                ...
                                if (r) {
                                    ...
                                    o = s.slides.filter(t => 1 * t.getAttribute("data-swiper-slide-index") === e)[0].column
                ...
                loop: {
                    ...
                    loopFix: function(e) {
                        ...
                        let y = v;
                        y % v != 0 && (y += v - y % v), y += h.loopAdditionalSlides, l.loopedSlides = y;
                        const b = l.grid && h.grid && h.grid.rows > 1;
                        d.length < m + y ? g("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled and not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters") : b && "row" === h.grid.fill && g("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
                        const w = [],
                            _ = [];
                        let E = l.activeIndex;
                        void 0 === r ? r = l.getSlideIndex(d.filter(e => e.classList.contains(h.slideActiveClass))[0]) : E = r;
                        const x = "next" === n || !n,
                            S = "prev" === n || !n;
                        let T = 0,
                            C = 0;
                        const M = b ? Math.ceil(d.length / h.grid.rows) : d.length,
                            L = (b ? d[r].column : r) + (f && void 0 === s ? -m / 2 + .5 : 0);
                        if (L < y) {
                            T = Math.max(y - L, v);
                        ...
                        if (l.__preventObserver__ = !0, requestAnimationFrame(() => {
                            ...
                            }), l.recalcSlides(), "auto" === h.slidesPerView ? l.updateSlides() : b && (w.length > 0 && S || _.length > 0 && x) && l.slides.forEach((e, t) => {
                            ...
                            if (w.length > 0 && S) {
                                if (void 0 === t) {
                                    ...
                                    a ? l.setTranslate(l.translate - t) : (l.slideTo(E + Math.ceil(T), 0, !1, !0), s && (l.touchEventsData.startTranslate = l.touchEventsData.startTranslate - t, l.touchEventsData.currentTranslate = l.touchEventsData.currentTranslate - t))
                                } else if (s) {
                            ...
                            if (void 0 === t) {
                                ...
                                a ? l.setTranslate(l.translate - t) : (l.slideTo(E - C, 0, !1, !0), s && (l.touchEventsData.startTranslate = l.touchEventsData.startTranslate - t, l.touchEventsData.currentTranslate = l.touchEventsData.currentTranslate - t))
                            } else {
                ...
                events: {
                    attachEvents: function() {
                        ...
                        e.onTouchStart = H.bind(e), e.onTouchMove = W.bind(e), e.onTouchEnd = B.bind(e), e.onDocumentTouchStart = G.bind(e), t.cssMode && (e.onScroll = q.bind(e)), e.onClick = F.bind(e), e.onLoad = Y.bind(e), $(e, "on")
                    },
                ...
                breakpoints: {
                    setBreakpoint: function() {
                        ...
                        const a = (o in r ? r[o] : void 0) || e.originalParams,
                            ...
                            p = a.grabCursor,
                            h = n.enabled;
                        l && !d ? (s.classList.remove(n.containerModifierClass + "grid", n.containerModifierClass + "grid-column"), e.emitContainerClasses()) : !l && d && (s.classList.add(n.containerModifierClass + "grid"), (a.grid.fill && "column" === a.grid.fill || !a.grid.fill && "column" === n.grid.fill) && s.classList.add(n.containerModifierClass + "grid-column"), e.emitContainerClasses()), c && !p ? e.unsetGrabCursor() : !c && p && e.setGrabCursor(), ["navigation", "pagination", "scrollbar"].forEach(t => {
                        ...
                        const f = a.direction && a.direction !== n.direction,
                            m = n.loop && (a.slidesPerView !== n.slidesPerView || f),
                            g = n.loop;
                        f && i && e.changeDirection(), u(e.params, a);
                        ...
                        }), h && !v ? e.disable() : !h && v && e.enable(), e.currentBreakpoint = o, e.emit("_beforeBreakpoint", a), i && (m ? (e.loopDestroy(), e.loopCreate(t), e.updateSlides()) : !g && y ? (e.loopCreate(t), e.updateSlides()) : g && !y && e.loopDestroy()), e.emit("breakpoint", a)
                    },
        ...
        class Z {
            constructor() {
                ...
                const a = this;
                a.__swiper__ = !0, a.support = L(), a.device = I({
                ...
                const d = u({}, X, l);
                return a.params = u({}, d, K, t), a.originalParams = u({}, a.params), a.passedParams = u({}, t), a.params && a.params.on && Object.keys(a.params.on).forEach(e => {
        ...
        const ce = [function(e) {
            ...
            function c(e, t) {
                ...
                let b, w, _;
                b = i.rtlTranslate ? "right" : i.isHorizontal() ? "left" : "top", r ? (w = Math.floor(n / 2) + s + u, _ = Math.floor(n / 2) + s + c) : (w = n + (s - 1) + u, _ = (a ? n : s) + c);
                let E = y - _,
                    x = y + w;
                a || (E = Math.max(E, 0), x = Math.min(x, f.length - 1));
                let S = (i.slidesGrid[E] || 0) - (i.slidesGrid[0] || 0);

                function T() {
                    i.updateSlides(), i.updateProgress(), i.updateSlidesClasses(), o("virtualUpdate")
                }
                if (a && y >= _ ? (E -= _, r || (S += i.slidesGrid[0])) : a && y < _ && (E = -_, r && (S += i.slidesGrid[0])), Object.assign(i.virtual, {
                        from: E,
                        to: x,
                        offset: S,
                        ...
                        slidesBefore: _,
                        slidesAfter: w
                    }), p === E && h === x && !e) return i.slidesGrid !== g && S !== v && i.slides.forEach(e => {
                    e.style[b] = S - Math.abs(i.cssOverflowAdjustment()) + "px"
                ...
                if (i.params.virtual.renderExternal) return i.params.virtual.renderExternal.call(i, {
                    ...
                    slides: function() {
                        const e = [];
                        for (let t = E; t <= x; t += 1) e.push(f[t]);
                        return e
                    }()
                ...
                if (e) i.slides.filter(e => e.matches(`.${i.params.slideClass}, swiper-slide`)).forEach(e => {
                    ...
                    for (let e = p; e <= h; e += 1)
                        ...
                        } const I = a ? -f.length : 0,
                    k = a ? 2 * f.length : f.length;
                for (let t = I; t < k; t += 1)
                    if (t >= E && t <= x) {
                        const i = L(t);
                        void 0 === h || e ? M.push(i) : (t > h && M.push(i), t < p && C.push(i))
                    } if (M.forEach(e => {
            ...
            function g(e) {
                ...
                if (v >= t.minTranslate() && (v = t.minTranslate()), v <= t.maxTranslate() && (v = t.maxTranslate()), n = !!t.params.loop || !(v === t.minTranslate() || v === t.maxTranslate()), n && t.params.nested && i.stopPropagation(), t.params.freeMode && t.params.freeMode.enabled) {
                    ...
                    if (!n) {
                        ...
                        if (n || s("scroll", i), t.params.autoplay && t.params.autoplayDisableOnInteraction && t.autoplay.stop(), r.releaseOnEdges && (o === t.minTranslate() || o === t.maxTranslate())) return !0
                    }
                } else {
                    const i = {
                        time: l(),
            ...
            function c() {
                ...
                const s = (i, n) => {
                    i && i.addEventListener("click", "next" === n ? d : l), !t.enabled && i && i.classList.add(...e.lockClass.split(" "))
                };
            ...
            function u() {
                ...
                if (t.params.loop ? (r = t.previousRealIndex || 0, n = t.params.slidesPerGroup > 1 ? Math.floor(t.realIndex / t.params.slidesPerGroup) : t.realIndex) : void 0 !== t.snapIndex ? (n = t.snapIndex, r = t.previousSnapIndex) : (r = t.previousIndex || 0, n = t.activeIndex || 0), "bullets" === i.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
                    ...
                    let l, u, p;
                    if (i.dynamicBullets && (o = x(s[0], t.isHorizontal() ? "width" : "height", !0), c.forEach(e => {
                        ...
                        }), c.length > 1) s.forEach(e => {
                        const s = w(e);
                        s === n ? e.classList.add(...i.bulletActiveClass.split(" ")) : t.isElement && e.setAttribute("part", "bullet"), i.dynamicBullets && (s >= l && s <= u && e.classList.add(...(i.bulletActiveClass + "-main").split(" ")), s === l && d(e, "prev"), s === u && d(e, "next"))
                    });
                    else {
                        const e = s[n];
            ...
            const m = () => {
                ...
                e && (e = S(e), e.forEach(e => e.classList.add(t.params.pagination.paginationDisabledClass))), f()
            };
            Object.assign(t.pagination, {
                enable: () => {
                    ...
                    e && (e = S(e), e.forEach(e => e.classList.remove(t.params.pagination.paginationDisabledClass))), h(), p(), u()
                },
                disable: m,
                render: p,
                update: u,
            ...
            function g() {
                ...
                let a = c,
                    l = (u - c) * o;
                i ? (l = -l, l > 0 ? (a = c - l, l = 0) : -l + c > u && (a = u + l)) : l < 0 ? (a = c + l, l = 0) : l + c > u && (a = u - l), t.isHorizontal() ? (n.style.transform = `translate3d(${l}px, 0, 0)`, n.style.width = a + "px") : (n.style.transform = `translate3d(0px, ${l}px, 0)`, n.style.height = a + "px"), r.hide && (clearTimeout(f), s.style.opacity = 1, f = setTimeout(() => {
            ...
            function b() {
                ...
                i.style.width = "", i.style.height = "", u = t.isHorizontal() ? n.offsetWidth : n.offsetHeight, p = t.size / (t.virtualSize + t.params.slidesOffsetBefore - (t.params.centeredSlides ? t.snapGrid[0] : 0)), c = "auto" === t.params.scrollbar.dragSize ? u * p : parseInt(t.params.scrollbar.dragSize, 10), t.isHorizontal() ? i.style.width = c + "px" : i.style.height = c + "px", n.style.display = p >= 1 ? "none" : "", t.params.scrollbar.hide && (n.style.opacity = 0), t.params.watchOverflow && t.enabled && e.el.classList[t.isLocked ? "add" : "remove"](t.params.scrollbar.lockClass)
            }
            ...
            function _(e) {
                ...
                let r;
                r = (w(e) - y(s)[t.isHorizontal() ? "left" : "top"] - (null !== d ? d : c / 2)) / (u - c), r = Math.max(Math.min(r, 1), 0), n && (r = 1 - r);
            ...
            function E(e) {
                ...
                h = !0, d = e.target === a ? w(e) - e.target.getBoundingClientRect()[t.isHorizontal() ? "left" : "top"] : null, e.preventDefault(), e.stopPropagation(), s.style.transitionDuration = "100ms", a.style.transitionDuration = "100ms", _(e), clearTimeout(m), o.style.transitionDuration = "0ms", i.hide && (o.style.opacity = 1), t.params.cssMode && (t.wrapperEl.style["scroll-snap-type"] = "none"), r("scrollbarDragStart", e)
            }
            ...
            function x(e) {
                ...
                h && (e.preventDefault && e.cancelable ? e.preventDefault() : e.returnValue = !1, _(e), n.style.transitionDuration = "0ms", s.style.transitionDuration = "0ms", o.style.transitionDuration = "0ms", r("scrollbarDragMove", e))
            }
            ...
            function T(e) {
                ...
                h && (h = !1, t.params.cssMode && (t.wrapperEl.style["scroll-snap-type"] = "", s.style.transitionDuration = ""), i.hide && (clearTimeout(m), m = a(() => {
            ...
            function C(e) {
                ...
                r[d]("pointerdown", E, o), l[d]("pointermove", x, o), l[d]("pointerup", T, a)
            }
            ...
            function M() {
                ...
                t.params.uniqueNavElements && "string" == typeof n.el && s.length > 1 && 1 === i.querySelectorAll(n.el).length && (s = i.querySelector(n.el)), s.length > 0 && (s = s[0]), s.classList.add(t.isHorizontal() ? n.horizontalClass : n.verticalClass), s && (r = s.querySelector(ee(t.params.scrollbar.dragClass)), r || (r = v("div", t.params.scrollbar.dragClass), s.append(r))), Object.assign(e, {
                    el: s,
                    dragEl: r
            ...
            function S(e) {
                ...
                if (a = !1, l = !1, p.push(e), !(p.length < 2)) {
                    if (a = !0, h.scaleStart = w(), !h.slideEl) {
                        ...
                        if (n && (n = n.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]), h.imageEl = n, h.imageWrapEl = n ? _(h.imageEl, "." + i.containerClass)[0] : void 0, !h.imageWrapEl) return void(h.imageEl = void 0);
                        h.maxRatio = E()
                    }
                    if (h.imageEl) {
                        const [e, t] = function() {
            ...
            function T(e) {
                ...
                s >= 0 && (p[s] = e), p.length < 2 || (l = !0, h.scaleMove = w(), h.imageEl && (n.scale = h.scaleMove / h.scaleStart * c, n.scale > h.maxRatio && (n.scale = h.maxRatio - 1 + (n.scale - h.maxRatio + 1) ** .5), n.scale < i.minRatio && (n.scale = i.minRatio + 1 - (i.minRatio - n.scale + 1) ** .5), h.imageEl.style.transform = `translate3d(0,0,0) scale(${n.scale})`))
            }
            ...
            function L(e) {
                ...
                const n = f.width * i.scale,
                    s = f.height * i.scale;
                if (f.minX = Math.min(h.slideWidth / 2 - n / 2, 0), f.maxX = -f.minX, f.minY = Math.min(h.slideHeight / 2 - s / 2, 0), f.maxY = -f.minY, f.touchesCurrent.x = p.length > 0 ? p[0].pageX : e.pageX, f.touchesCurrent.y = p.length > 0 ? p[0].pageY : e.pageY, Math.max(Math.abs(f.touchesCurrent.x - f.touchesStart.x), Math.abs(f.touchesCurrent.y - f.touchesStart.y)) > 5 && (t.allowClick = !1), !f.isMoved && !u) {
                    if (t.isHorizontal() && (Math.floor(f.minX) === Math.floor(f.startX) && f.touchesCurrent.x < f.touchesStart.x || Math.floor(f.maxX) === Math.floor(f.startX) && f.touchesCurrent.x > f.touchesStart.x)) return f.isTouched = !1, void M();
                    if (!t.isHorizontal() && (Math.floor(f.minY) === Math.floor(f.startY) && f.touchesCurrent.y < f.touchesStart.y || Math.floor(f.maxY) === Math.floor(f.startY) && f.touchesCurrent.y > f.touchesStart.y)) return f.isTouched = !1, void M()
                }
            ...
            function k(e) {
                ...
                if (!h.slideEl) {
                    ...
                    i && (i = i.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]), h.imageEl = i, h.imageWrapEl = i ? _(h.imageEl, "." + n.containerClass)[0] : void 0
                }
                if (!h.imageEl || !h.imageWrapEl) return;
                let s, r, a, l, d, u, p, g, v, b, w, x, S, T, C, M, L, I;
                t.params.cssMode && (t.wrapperEl.style.overflow = "hidden", t.wrapperEl.style.touchAction = "none"), h.slideEl.classList.add("" + n.zoomedSlideClass), void 0 === f.touchesStart.x && e ? (s = e.pageX, r = e.pageY) : (s = f.touchesStart.x, r = f.touchesStart.y);
                const k = "number" == typeof e ? e : null;
                1 === c && k && (s = void 0, r = void 0);
                const O = E();
                i.scale = k || O, c = k || O, !e || 1 === c && k ? (p = 0, g = 0) : (L = h.slideEl.offsetWidth, I = h.slideEl.offsetHeight, a = y(h.slideEl).left + o.scrollX, l = y(h.slideEl).top + o.scrollY, d = a + L / 2 - s, u = l + I / 2 - r, v = h.imageEl.offsetWidth || h.imageEl.clientWidth, b = h.imageEl.offsetHeight || h.imageEl.clientHeight, w = v * i.scale, x = b * i.scale, S = Math.min(L / 2 - w / 2, 0), T = Math.min(I / 2 - x / 2, 0), C = -S, M = -T, p = d * i.scale, g = u * i.scale, p < S && (p = S), p > C && (p = C), g < T && (g = T), g > M && (g = M)), k && 1 === i.scale && (h.originX = 0, h.originY = 0), h.imageWrapEl.style.transitionDuration = "300ms", h.imageWrapEl.style.transform = `translate3d(${p}px, ${g}px,0)`, h.imageEl.style.transitionDuration = "300ms", h.imageEl.style.transform = `translate3d(0,0,0) scale(${i.scale})`
            }
            ...
            function z() {
                ...
                t.wrapperEl.addEventListener("pointerdown", S, i), t.wrapperEl.addEventListener("pointermove", T, n), ["pointerup", "pointercancel", "pointerout"].forEach(e => {
            ...
            function D() {
                ...
                t.wrapperEl.removeEventListener("pointerdown", S, i), t.wrapperEl.removeEventListener("pointermove", T, n), ["pointerup", "pointercancel", "pointerout"].forEach(e => {
            ...
            Object.defineProperty(t.zoom, "scale", {
                ...
                t.zoom.enabled && function() {
                    ...
                    const s = g.x * i,
                        ...
                        o = g.y * n,
                        a = f.currentY + o;
                    0 !== g.x && (i = Math.abs((r - f.currentX) / g.x)), 0 !== g.y && (n = Math.abs((a - f.currentY) / g.y));
            ...
            function y(e) {
                ...
                const i = t.params.a11y,
                    n = e.target;
                if (!t.pagination || !t.pagination.el || n !== t.pagination.el && !t.pagination.el.contains(e.target) || e.target.matches(ee(t.params.pagination.bulletClass))) {
                    if (t.navigation && t.navigation.prevEl && t.navigation.nextEl) {
                        const e = S(t.navigation.prevEl);
                        S(t.navigation.nextEl).includes(n) && (t.isEnd && !t.params.loop || t.slideNext(), t.isEnd ? d(i.lastSlideMessage) : d(i.nextSlideMessage)), e.includes(n) && (t.isBeginning && !t.params.loop || t.slidePrev(), t.isBeginning ? d(i.firstSlideMessage) : d(i.prevSlideMessage))
                    }
                    t.pagination && n.matches(ee(t.params.pagination.bulletClass)) && n.click()
                }
            }
            ...
            const E = (e, t, i) => {
                    c(e), "BUTTON" !== e.tagName && (p(e, "button"), e.addEventListener("keydown", y)), f(e, i),
                        function(e, t) {
                            (e = S(e)).forEach(e => {
                ...
                L = () => {
                    ...
                    e.itemRoleDescriptionMessage && h(t.slides, e.itemRoleDescriptionMessage), e.slideRole && p(t.slides, e.slideRole);
            ...
            s("beforeInit", () => {
                ...
                t.params.a11y.enabled && (() => {
                    ...
                    t.el.append(a);
                    const i = t.el;
                    e.containerRoleDescriptionMessage && h(i, e.containerRoleDescriptionMessage), e.containerMessage && f(i, e.containerMessage);
                    const s = t.wrapperEl,
                    ...
                    c = S(c), u = S(u), c && c.forEach(t => E(t, r, e.nextSlideMessage)), u && u.forEach(t => E(t, r, e.prevSlideMessage)), _() && S(t.pagination.el).forEach(e => {
                ...
                t.params.a11y.enabled && function() {
                    ...
                    i && (t.isBeginning ? (m(i), u(i)) : (g(i), c(i))), e && (t.isEnd ? (m(e), u(e)) : (g(e), c(e)))
                }()
            }), s("paginationUpdate", () => {
                t.params.a11y.enabled && function() {
                    const e = t.params.a11y;
                    b() && t.pagination.bullets.forEach(i => {
                        t.params.pagination.clickable && (c(i), t.params.pagination.renderBullet || (p(i, "button"), f(i, e.paginationBulletMessage.replace(/\{\{index\}\}/, w(i) + 1)))), i.matches(ee(t.params.pagination.bulletActiveClass)) ? i.setAttribute("aria-current", "true") : i.removeAttribute("aria-current")
                    })
                }()
            }), s("destroy", () => {
                t.params.a11y.enabled && function() {
                    ...
                    e = S(e), i = S(i), e && e.forEach(e => e.removeEventListener("keydown", y)), i && i.forEach(e => e.removeEventListener("keydown", y)), _() && S(t.pagination.el).forEach(e => {
            ...
            let d, c, u, p, h, f, m, g, v = l && l.autoplay ? l.autoplay.delay : 3e3,
            ...
            const _ = () => {
                    ...
                    const e = s.autoplay.paused ? d : b + y - (new Date).getTime();
                ...
                E = e => {
                    ...
                    !Number.isNaN(r) && r > 0 && void 0 === e && (n = r, v = r, y = r), d = n;
                ...
                x = () => {
                    b = (new Date).getTime(), s.autoplay.running = !0, E(), a("autoplayStart")
                },
                S = () => {
                ...
                T = (e, i) => {
                    ...
                    d = r - ((new Date).getTime() - b), s.isEnd && d < 0 && !s.params.loop || (d < 0 && (d = 0), n())
                },
                C = () => {
                    s.isEnd && d < 0 && !s.params.loop || s.destroyed || !s.autoplay.running || (b = (new Date).getTime(), m ? (m = !1, E(d)) : E(), s.autoplay.paused = !1, a("autoplayResume"))
                },
                M = () => {
                    if (s.destroyed || !s.autoplay.running) return;
                    const e = n();
                    ...
                    onTouchEnd: function(e) {
                        ...
                        if (i < -t.minTranslate()) t.slideTo(t.activeIndex);
                            ...
                            if (r.freeMode.momentum) {
                                ...
                                r.freeMode.momentumBounce && h ? (t.updateProgress(p), t.setTransition(e), t.setTranslate(u), t.transitionStart(!0, t.swipeDirection), t.animating = !0, E(o, () => {
                                    t && !t.destroyed && c.allowMomentumBounce && (n("momentumBounce"), t.setTransition(r.speed), setTimeout(() => {
                                        t.setTranslate(p), E(o, () => {
                                            t && !t.destroyed && t.transitionEnd()
                                        })
                                    }, 0))
                                })) : t.velocity ? (n("_freeModeNoMomentumRelease"), t.updateProgress(u), t.setTransition(e), t.setTranslate(u), t.transitionStart(!0, t.swipeDirection), t.animating || (t.animating = !0, E(o, () => {
                                    t && !t.destroyed && t.transitionEnd()
            ...
            a("init", () => {
                ...
                updateSlide: (e, s, o) => {
                    ...
                    if ("row" === u && a > 1) {
                        ...
                        m = Math.floor(n / r), f = n - m * r + i * a, h = f + m * t / c, s.style.order = h
                    } else "column" === u ? (f = Math.floor(e / c), m = e - f * c, (f > n || f === n && m === c - 1) && (m += 1, m >= c && (m = 0, f += 1))) : (m = Math.floor(e / i), f = e - m * i);
                    s.row = m, s.column = f, s.style.height = `calc((100% - ${(c - 1) * d}px) / ${c})`, s.style[r.getDirectionLabel("margin-top")] = 0 !== m ? d && d + "px" : "", s.swiperSlideGridSet = !0
                },
            ...
            oe({
                ...
                setTranslate: () => {
                    ...
                    let h, f = 0;
                    c.shadow && (u ? (h = t.wrapperEl.querySelector(".swiper-cube-shadow"), h || (h = v("div", "swiper-cube-shadow"), t.wrapperEl.append(h)), h.style.height = r + "px") : (h = e.querySelector(".swiper-cube-shadow"), h || (h = v("div", "swiper-cube-shadow"), e.append(h))));
                    for (let e = 0; e < n.length; e += 1) {
                        const i = n[e];
                        let r = e;
                        ...
                        let o = 90 * r,
                            d = Math.floor(o / 360);
                        a && (o = -o, d = Math.floor(-o / 360));
                        const h = Math.max(Math.min(i.progress, 1), -1);
                        let m = 0,
                            g = 0,
                            v = 0;
                        r % 4 == 0 ? (m = 4 * -d * l, v = 0) : (r - 1) % 4 == 0 ? (m = 0, v = 4 * -d * l) : (r - 2) % 4 == 0 ? (m = l + 4 * d * l, v = l) : (r - 3) % 4 == 0 && (m = -l, v = 3 * l + 4 * l * d), a && (m = -m), u || (g = m, m = 0);
                        const y = `rotateX(${u ? 0 : -o}deg) rotateY(${u ? o : 0}deg) translate3d(${m}px, ${g}px, ${v}px)`;
                        h <= 1 && h > -1 && (f = 90 * r + 90 * h, a && (f = 90 * -r - 90 * h), t.browser && t.browser.need3dFix && Math.abs(f) / 90 % 2 == 1 && (f += .001)), i.style.transform = y, c.slideShadows && s(i, h, u)
                    }
                    if (i.style.transformOrigin = `50% 50% -${l / 2}px`, i.style["-webkit-transform-origin"] = `50% 50% -${l / 2}px`, c.shadow)
                        if (u) h.style.transform = `translate3d(0px, ${r / 2 + c.shadowOffset}px, ${-r / 2}px) rotateX(89.99deg) rotateZ(0deg) scale(${c.shadowScale})`;
                        else {
                ...
                setTranslate: () => {
                    ...
                    for (let r = 0; r < e.length; r += 1) {
                        ...
                        let d = -180 * a,
                            ...
                            p = 0;
                        t.isHorizontal() ? i && (d = -d) : (p = u, u = 0, c = -d, d = 0), t.browser && t.browser.need3dFix && (Math.abs(d) / 90 % 2 == 1 && (d += .001), Math.abs(c) / 90 % 2 == 1 && (c += .001)), o.style.zIndex = -Math.abs(Math.round(a)) + e.length, n.slideShadows && s(o, a);
                ...
                setTranslate: () => {
                    ...
                    for (let e = 0, i = n.length; e < i; e += 1) {
                        const i = n[e],
                            ...
                            p = "function" == typeof r.modifier ? r.modifier(u) : u * r.modifier;
                        let h = o ? d * p : 0,
                            f = o ? 0 : d * p,
                            m = -c * Math.abs(p),
                            g = r.stretch;
                        "string" == typeof g && -1 !== g.indexOf("%") && (g = parseFloat(r.stretch) / 100 * a);
                        let v = o ? 0 : g * p,
                            y = o ? g * p : 0,
                            b = 1 - (1 - r.scale) * Math.abs(p);
                        Math.abs(y) < .001 && (y = 0), Math.abs(v) < .001 && (v = 0), Math.abs(m) < .001 && (m = 0), Math.abs(h) < .001 && (h = 0), Math.abs(f) < .001 && (f = 0), Math.abs(b) < .001 && (b = 0), t.browser && t.browser.need3dFix && (Math.abs(h) / 90 % 2 == 1 && (h += .001), Math.abs(f) / 90 % 2 == 1 && (f += .001));
                        const w = `translate3d(${y}px,${v}px,${m}px)  rotateX(${f}deg) rotateY(${h}deg) scale(${b})`;
                        if (ae(0, i).style.transform = w, i.style.zIndex = 1 - Math.abs(Math.round(p)), r.slideShadows) {
                            let e = o ? i.querySelector(".swiper-slide-shadow-left") : i.querySelector(".swiper-slide-shadow-top"),
                                t = o ? i.querySelector(".swiper-slide-shadow-right") : i.querySelector(".swiper-slide-shadow-bottom");
                            e || (e = de("coverflow", i, o ? "left" : "top")), t || (t = de("coverflow", i, o ? "right" : "bottom")), e && (e.style.opacity = p > 0 ? p : 0), t && (t.style.opacity = -p > 0 ? -p : 0)
                        }
                    }
                },
                setTransition: e => {
                ...
                setTranslate: () => {
                    ...
                    for (let i = 0; i < e.length; i += 1) {
                        ...
                        d < 0 ? (m = r.next, f = !0) : d > 0 && (m = r.prev, f = !0), p.forEach((e, t) => {
                            ...
                            let n = m.rotate[i] * Math.abs(d * o);
                            t.browser && t.browser.need3dFix && Math.abs(n) / 90 % 2 == 1 && (n += .001), h[i] = n
            ...
            i({
                ...
                setTranslate: () => {
                    ...
                    for (let l = 0; l < e.length; l += 1) {
                        ...
                        d.style.zIndex = -Math.abs(Math.round(c)) + e.length, ae(0, d).style.transform = x
                    }
                },
                setTransition: e => {
                    const i = t.slides.map(e => f(e));
